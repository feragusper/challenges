...
class MinAvgTwoSlice {
    ...
    @Test
    fun test() {
        assert(solution(intArrayOf(4, 2, 2, 5, 1, 5, 8)) == 1)
    }

    private fun solution(a: IntArray): Int {
        var minAvg = Double.MAX_VALUE // Tracks the minimum average
        var minIndex = 0 // Tracks the starting index of the slice with the minimum average
